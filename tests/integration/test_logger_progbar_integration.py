...
class TestTimedLoggerIntegration:
    ...
    def test_timed_with_logging(self, caplog):
        ...
        assert any(
            "Processing data: test data" in record.message for record in caplog.records
        )
...
class TestComplexIntegrationScenarios:
    ...
    def test_error_recovery_scenario(self, caplog):
        ...
        # Should have logged the error
        assert any(
            "Error in risky_operation" in record.message for record in caplog.records
        )
